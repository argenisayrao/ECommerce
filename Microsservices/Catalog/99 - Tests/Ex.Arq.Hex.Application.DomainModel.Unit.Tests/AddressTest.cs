...
namespace Ex.Arq.Hex.Application.DomainModel.Units.Tests
{
    public class AddressTest
    {
        ...
        {
            Exception exception = Assert.Throws<AddressException>(() =>
            new Address(_id, country, _state, _zipCode, _city, _street, _number));
        ...
        {
            Exception exception = Assert.Throws<AddressException>(() =>
            new Address(_id, _country, state, _zipCode, _city, _street, _number));
        ...
        {
            Exception exception = Assert.Throws<AddressException>(() =>
            new Address(_id, _country, _state, zipCode, _city, _street, _number));
        ...
        {
            Exception exception = Assert.Throws<AddressException>(() =>
            new Address(_id, _country, _state, _zipCode, city, _street, _number));
        ...
        {
            Exception exception = Assert.Throws<AddressException>(() =>
            new Address(_id, _country, _state, _zipCode, _city, street, _number));
        ...
        public void Address_WhenInvalidCity_AddressExcpetionWithMessageInvalidNumber()
        {
            int number=0;
            Exception exception = Assert.Throws<AddressException>(() =>
            new Address(_id, _country, _state, _zipCode, _city, _street, number));
