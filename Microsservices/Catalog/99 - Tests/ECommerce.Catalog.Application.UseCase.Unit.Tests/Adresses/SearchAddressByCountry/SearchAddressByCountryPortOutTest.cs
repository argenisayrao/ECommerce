...
{
    public class SearchAddressByCountryPortOutTest
    {
        ...
        public SearchAddressByCountryPortOutTest()
        {
            _id = Guid.NewGuid();
            _country = "Brazil";
            _state = "Minas Gerais";
        ...
        {
            var address = new SearchAddressByCountryPortOut(_id, _country, _state, _zipCode, _city, _street, _number);
        ...
        public void Address_WhenInvalidCountry_AddressExcpetionWithMessageInvalidCountry(string country)
        {
            ...
            new SearchAddressByCountryPortOut(_id, country, _state, _zipCode, _city, _street, _number));
        ...
        {
            Exception exception = Assert.Throws<BaseAddressPortException>(() =>
            new SearchAddressByCountryPortOut(_id, _country, state, _zipCode, _city, _street, _number));
        ...
        {
            Exception exception = Assert.Throws<BaseAddressPortException>(() =>
            new SearchAddressByCountryPortOut(_id, _country, _state, zipCode, _city, _street, _number));
        ...
        {
            Exception exception = Assert.Throws<BaseAddressPortException>(() =>
            new SearchAddressByCountryPortOut(_id, _country, _state, _zipCode, city, _street, _number));
        ...
        {
            Exception exception = Assert.Throws<BaseAddressPortException>(() =>
            new SearchAddressByCountryPortOut(_id, _country, _state, _zipCode, _city, street, _number));
        ...
        public void Address_WhenInvalidCity_AddressExcpetionWithMessageInvalidNumber()
        {
            int number = 0;
            Exception exception = Assert.Throws<BaseAddressPortException>(() =>
            new SearchAddressByCountryPortOut(_id, _country, _state, _zipCode, _city, _street, number));
